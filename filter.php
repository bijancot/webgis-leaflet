...
<body>
    ...
    <table border="1">
        ...
        if(isset($_GET['cari'])){
            ...
            $db = $mysqli->prepare("SELECT * FROM jenisProperti a JOIN properti b on a.JenisID=b.JenisID WHERE Harga like %?% OR Luas like %?% OR Jarak like %?% OR Jumlah_cicil like %?% OR Tahun_bangun like %?%");
