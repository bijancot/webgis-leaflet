...
echo "var rmhElite = L.layerGroup();\n";
...
foreach ($res as $key => $sult) {
    echo "var part_elit_".$count." = '<h2>Perumahan Elite".$sult['NamaProperti']."</h2><div class=\"columns\">'+
		'<div class=\"column\">' +
	...
	echo "var customOptions_elite_".$count." =
        {
        'maxWidth': '800',
        'maxheight': '800',
        'minWidth': '800',
        'className' : 'custom_elite_".$count,"'
        }\n";
    echo "L.marker([".$sult['Latitude'].",".$sult['Longitude']."]).bindPopup(part_elite_".$count,", customOptions_elite_".$count.").addTo(rmhEllite);";
