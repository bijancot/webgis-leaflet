...
foreach ($res as $key => $sult) {
    echo "var part_kav_ = '<h4>Judul </h4><div class=\"columns\">'+
		'<div class=\"column\">' +
	...
	echo "var customOptions_kav =
        {
        'maxWidth': '500',
        'className' : 'custom_kav'
        }";
    echo "L.marker([".$sult['Latitude'].",".$sult['Longitude']."]).bindPopup(part_kav_, customOptions_kav).addTo(kavling);";
